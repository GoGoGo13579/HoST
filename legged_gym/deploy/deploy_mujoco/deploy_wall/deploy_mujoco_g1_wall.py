...
def main():
    parser = argparse.ArgumentParser(description='部署G1靠墙坐姿场景')
    parser.add_argument('--model_path', type=str, default=None, 
                       help='ONNX模型文件路径')
    parser.add_argument('--config', type=str, 
                       default='/home/shenlan/HoST/legged_gym/deploy/deploy_mujoco/deploy_wall/g1_wall_config.yaml',
                       help='配置文件路径')
    ...
    data.qpos[7:7+num_joints] = initial_pose['joint_angles']
    data.qvel[:] = 0
